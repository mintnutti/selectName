   ...
   dataSelect?.sort(function (a, b) {
    ...
    const defaultTime =[
        ...
        const dataSatgeFrist =[
            ...
            {id:48,Artist:'ไปส่งกู บขส.ดู๊',start:'2022/12/09 00:15',end:'01:00',time:45,stage:5},
        ...
        const dataSatgeSecond =[
            ...
            {id:90,Artist:'Kin, matcha, alala',start:'2022/12/10 16:30',end:'17:15',time:45,stage:2},
            {id:91,Artist:'monica, firzter',start:'2022/12/10 17:30',end:'18:15',time:45,stage:2},
            {id:92,Artist:'tigger x perses x viis',start:'2022/12/10 18:30',end:'19:15',time:45,stage:2},
            {id:93,Artist:'proxie',start:'2022/12/10 19:30',end:'20:15',time:45,stage:2},
            {id:94,Artist:'2002 ratree',start:'2022/12/10 20:30',end:'21:15',time:45,stage:2},
            {id:95,Artist:'pop pongkool',start:'2022/12/10 21:30',end:'22:15',time:45,stage:2},
            {id:96,Artist:'stamp',start:'2022/12/10 22:30',end:'23:15',time:45,stage:2},
            {id:97,Artist:'polycat',start:'2022/12/10 23:30',end:'00:15',time:45,stage:2},
            {id:98,Artist:'paradox',start:'2022/12/10 00:30',end:'01:15',time:45,stage:2},
